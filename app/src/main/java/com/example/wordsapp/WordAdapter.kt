...
class WordAdapter(private val selectedLetter: String, context: Context) : RecyclerView.Adapter<WordAdapter.WordViewHolder>() {
    ...
    init {
        ...
        filteredWords = allWords
            .filter { it.startsWith(selectedLetter, ignoreCase = true) }
            .sorted()
    }

    class WordViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        val wordButton: Button = view.findViewById(R.id.button_item)
    }
